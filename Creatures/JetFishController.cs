...
{
    public class JetFishController : CreatureController
    {
        ...
        public JetFishController(JetFish fish, OnlineCreature oc, int playerNumber, CreatureCustomization customization) : base(fish, oc, playerNumber, new ExpandedAvatarData(customization))
        {
            this.fish = fish;
        }
        ...
        public static void On_JetFish_Update(On.JetFish.orig_Update orig, JetFish self, bool eu)
        {
            if (creatureControllers.TryGetValue(self, out var cc))
            {
                ...
                else if (cc is JetFishController fish)
                {
                    fish.jumpTime = 0;
        ...
        {
            if (creatureControllers.TryGetValue(self, out var cc) && cc is JetFishController fish)
            {
