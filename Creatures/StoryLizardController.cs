...
public class StoryLizardController : LizardController//, IStoryCreatureController
{
    ...
    /*public static void On_Lizard_Act(On.Lizard.orig_Act orig, Lizard self)
    {
        ...
        if (creatureControllers.TryGetValue(self, out var c) && c is StoryLizardController l)
        {
            l.ConsciousUpdate();
        }
        orig(self);
