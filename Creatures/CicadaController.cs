...
{
    public class CicadaController : RainMeadow.CicadaController
    {
        public bool lastThrow;
        public int grabHeld;
        public CicadaController(Cicada creature, OnlineCreature oc, int playerNumber, CreatureCustomization customization) : base(creature, oc, playerNumber, new ExpandedAvatarData(customization))
        {
        }
