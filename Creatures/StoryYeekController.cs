...
public class StoryYeekController : GroundCreatureController
{
    public Yeek yeek;
    ...
    public StoryYeekController(Yeek yeek, OnlineCreature oc, int playerNumber, SlugcatCustomization customization) : base(yeek, oc, playerNumber, new ExpandedAvatarData(customization))
    {
        this.yeek = yeek;
    ...
    public void BiteEdible(bool eu)
    {
        ...
        if (yeek.grasps[0] != null && grabbed is IPlayerEdible edible && edible.Edible)
        {
            ...
            {
                (grabbed as Creature).SetKillTag(yeek.abstractCreature);
            }
    ...
    public static void On_Yeek_Climb(On.MoreSlugcats.Yeek.orig_Climb orig, Yeek self, IntVector2 climbTile)
    {
        if (OnlineManager.lobby != null && CreatureController.creatureControllers.TryGetValue(self, out var cc))
        {
            ...
            // copy pasted from safari control code, and i don't really get what the point of this is
