...
{
    public class SlugNPCController : CreatureController
    {
        public Player pup;
        public SlugNPCController(Player pup, OnlineCreature oc, int playerNumber, CreatureCustomization customization) : base(pup, oc, playerNumber, new ExpandedAvatarData(customization))
        {
            this.pup = pup;
