...
{
    public class LanternMouseController : RainMeadow.LanternMouseController
    {
        ...
        public bool silly;
        public LanternMouseController(LanternMouse mouse, OnlineCreature oc, int playerNumber, CreatureCustomization customization) : base(mouse, oc, playerNumber, new ExpandedAvatarData(customization))
        {
        }
