...
{
    public class BigEelController : RainMeadow.CreatureController
    {
        ...
        public BigEelController(BigEel eel, OnlineCreature oc, int playerNumber, CreatureCustomization customization) : base(eel, oc, playerNumber, new ExpandedAvatarData(customization))
        {
            this.eel = eel;
