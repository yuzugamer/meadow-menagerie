...
public sealed class Options : OptionInterface
{
    ...
    public static Configurable<bool> NootAutoAim;
    ...
    public Options()
    {
        ...
        NootAutoAim = config.Bind("cfgMenagerieNootAutoAim", true);
    }
    ...
    public override void Initialize()
    {
        ...
        var nootButton = new OpCheckBox(NootAutoAim, 20, 360);
        var nootLabel = new OpLabel(52, 363, "Noodlefly Auto Aim");
        ...
        Tabs[0].AddItems(modName, toggleButton, toggleLabel, nootButton, nootLabel);
